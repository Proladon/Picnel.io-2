<template>
    <div id="folderslist">
        ...
        <splitpanes>
                ...
                <draggable v-model="folderlist" v-bind="dragOptions">
                    <transition-group type="transition">
                        <div v-for="(i, index) in folderlist" :key="i.name" class="draggable-folder"
                            ...
                            <div class="color-tag" @click="choiceColor(i.name, i.color, index)"
            ...
            <pane>
                <draggable v-model="foldergroups" v-bind="dragOptions">
                    <div class="draggable-group" v-for="(group, index) in foldergroups" :key="group.name"
                        @click="changeGroup(group.name, $event)" @contextmenu="groupcontext($event, index)">
                        {{ group.name }}
                    </div>
                </draggable>
            </pane>
        ...
        <!-- Notify -->
        <notifications group="folderlist" position="right bottom" animation-type="velocity" />
    </div>
</template>
...
<script>
    ...
    import {
        savefilter
    } from "@/assets/func/savefilter.js";
    export default {
        name: "Folderslist",
        components: {
            Splitpanes,
